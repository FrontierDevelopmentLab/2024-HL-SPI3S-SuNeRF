...
########################################################################
#
# Routines for reading/writing PSI style HDF5 data files.
#
# - Use rdhdf_1d, rdhdf_2d, and rdhdf_3d for reading.
#
# - Use wrhdf_1d, wrhdf_2d, and wrhdf_3d for writing.
#
# - Do not use rdh5 or wrh5 directly (use the wrappers mentioned above).
#
########################################################################
#
#  Version 1.0.0 (from Pot3D repo)
#
########################################################################
